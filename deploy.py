...
# def crop_img(frame_image,bbox,file_path)
...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load(r'C:\Users\sanke\Desktop\yolov5_deploy-main\yolov5_deploy-main\yolov5-master','custom', source ='local', path='last.pt',force_reload=True) ### The repo is stored locally
...
main(vid_path=0,vid_out="webcam_facemask_result.avi") #### for webcam
#main(img_path="OIP.jfif") ## for image
